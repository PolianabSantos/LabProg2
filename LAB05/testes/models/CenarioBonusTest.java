...
public class CenarioBonusTest {
	...
	public void criarCenarioBonus() {
		cenario1 = new CenarioBonus("Alisson vai tirar 10 na prova de LP2!", 1000);
	...
	public void toStringTestCenarioBonusNaoFinalizado() {
		assertEquals(this.cenario1.toString(), "Alisson vai tirar 10 na prova de LP2! - Nao finalizado - R$ 10,00");
	}

	@Test
	public void toStringTestCenarioBonusFinalizadoOcorreu() {
		this.cenario1.setEstado(Estado.FINALIZADO_OCORREU);
		assertEquals(this.cenario1.toString(), "Alisson vai tirar 10 na prova de LP2! - Finalizado (ocorreu) - R$ 10,00");
	}

	@Test
	public void toStringTestCenarioBonusFinalizado() {
		this.cenario1.setEstado(Estado.FINALIZADO_N_OCORREU);
		assertEquals(this.cenario1.toString(), "Alisson vai tirar 10 na prova de LP2! - Finalizado (n ocorreu) - R$ 10,00");
	}
